...
class ProducerRepositoryTest {
    ...
    void relationshipTest() {
        ...
        Product product2 = saveProduct("네모  공책", 100, 1200);
        Product product3 = saveProduct("지우개", 150, 1666);
    ...
    void relationshipTest2() {
        ...
        System.out.println("producets : " + producerRepository.findById(1L).get().getProducts());
